...
export const selectSeasonState = (state: RootState) =>
  state.startPage.seasonState;
export const selectTours = (state: RootState) => state.startPage.tours;
export const selectSeasonNumber = (state: RootState) =>
  state.startPage.seasonNumber;
export const selectGridRow = (state: RootState) => state.startPage.gridRow;
export const selectPreviusSeasons = (state: RootState) =>
  state.startPage.previusSeasons;
export const selectLeaguesCnt = (state: RootState) =>
  state.startPage.leaguesCnt;
