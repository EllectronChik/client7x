...
export const MESSAGES = {
    [LOCALES.ENGLISH]: {
        ...
        teamCompletedStatusDescription: 'By clicking on a team name, you will set the "Completed" status for the tournament and give the specified team a winner status.',
        playerWinnerStatusDescription: "By clicking on a player's name you will give him the status of the winner of the match.",
        endGameAndDeclareWinnerDescription: 'By clicking on the "Completed" checkbox you will end the game and also give the winner status to the team with the most points. {br} If the score is zero, the winner must be selected manually.',
        editMatchModeDescription: "By clicking on the {edit} symbol you will go to the match editing mode and you will be able to change the players and the map name.",
        deleteMatchDescription: "By clicking on the {delete} symbol you will delete the match.", 
    ...
    [LOCALES.RUSSIAN]: {
        ...
        teamCompletedStatusDescription: 'Нажав на название команды, вы установите статус "Завершено" для турнира и присвоите указанной команде статус победителя.',
        playerWinnerStatusDescription: "Нажав на имя игрока, вы присвоите ему статус победителя матча.",
        endGameAndDeclareWinnerDescription: 'Нажав на флажок "Завершено", вы завершите игру и также присвоите статус победителя команде с наибольшим количеством очков. {br} Если счет равен нулю, победителя следует выбрать вручную.',
        editMatchModeDescription: "Нажав на символ {edit}, вы перейдете в режим редактирования матча и сможете изменить игроков и название карты.",
    ...
    [LOCALES.UKRAINIAN]: {
        ...
        teamCompletedStatusDescription: 'Натискання на назву команди встановить статус "Завершено" для турніру та присвоїть вказаній команді статус переможця.',
        playerWinnerStatusDescription: "Натискання на ім'я гравця надасть йому статус переможця матчу.",
        endGameAndDeclareWinnerDescription: 'Натискання на прапорець "Завершено" завершить гру та також присвоїть статус переможця команді з найбільшою кількістю очок. {br} Якщо рахунок дорівнює нулю, переможця слід обрати вручну.',
        editMatchModeDescription: "Натискання на символ {edit} введе вас в режим редагування матчу, і ви зможете змінити гравців та назву карти.",
