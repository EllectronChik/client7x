...
export const MESSAGES = {
    [LOCALES.ENGLISH]: {
        ...
        referee_ask: 'Click here to submit a request for referee status and it will be reviewed by the administration',
        ...
        team: "Team",
        staff: "Staff panel",
        ask_for_staff_notification: "User {name} asked for staff status.",
        accept: "Accept",
        decline: "Decline",
    },
    [LOCALES.RUSSIAN]: {
        ...
        referee_ask: 'Нажмите здесь, чтобы подать заявку на статус судьи и она будет рассмотрена администрацией',
        ...
        ask_for_staff_notification: "Пользователь {name} запросил статус судьи.",
        accept: "Принять",
        decline: "Отклонить",
    },
    [LOCALES.UKRAINIAN]: {
        ...
        referee_ask: 'Натисніть тут, щоб подати запит на отримання статусу судді, і це буде розглянуто адміністрацією',
        ...
        ask_for_staff_notification: "Користувач {name} запросив статус суді.",
        accept: "Прийняти",
        decline: "Відхилити",
    }
}