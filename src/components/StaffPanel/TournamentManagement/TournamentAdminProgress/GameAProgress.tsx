...
const GameAProgress: FC<IProps> = ({
    ...
    {matches[tournament.id] && playersInTeams && Object.keys(playersInTeams).length > 0 && Object.values(matches[tournament.id]).map((match: IMatch) => {
      return <div key={match.id}>
        {!matchEdit[match.id] && <div className={classes.matchContainer}>
            ...
            <h3 className={`${classes.player} ${classes.playerOne} ${match.winner === match.player_one ? classes.winner : ''}`}
              ...
              {playersInTeams && playersInTeams[tournament.teamOne] && playersInTeams[tournament.teamOne][match.player_one]}
              </h3>
            <h3>VS</h3>
          ...
          <div className={classes.matchInfo}>
              ...
              <button className={classes.editButton} 
                ...
                <img className={classes.edit} src={editWhite} alt="edit" draggable="false"/>
              </button>
              {!deletedMatches.includes(match.id) && <button className={classes.deleteButton} onClick={() => {
                ...
                <img className={classes.delete} src={deleteWhite} alt="delete" draggable="false"/>
              </button>}
