  ...
  return (
    <div className={classes.seasonContent}>
      ...
      <div className={classes.gridBox}>
        <h2 className={classes.playOffLabel}><FormattedMessage id="playoff" />:</h2>
        <div className={classes.grid}>
          {gridRow === 0 && <h3>The tournament grid has not yet been determined</h3>}
          {Array.from(Array(gridRow).keys()).map((row) => (
            <div key={row} className={classes.row}>
              ...
              <div className={classes.thirdPlace}>
                ...
                <div className={classes.teamBox}>
                  <h3 className={`${classes.team} ${tours.playoff[999][0]?.winner === tours.playoff[999][0]?.teamOne ? classes.winner : ''}`}>
                    {tours.playoff[999][0]?.teamOne}
                  </h3>
                  <h3 className={`${classes.score} ${tours.playoff[999][0]?.winner === tours.playoff[999][0]?.teamOne ? classes.winner : ''}`}>
                    {tours.playoff[999][0]?.teamOneWins}
                  </h3>
                </div>
                <div className={classes.teamBox}>
                  <h3 className={`${classes.team} ${tours.playoff[999][0]?.winner === tours.playoff[999][0]?.teamTwo ? classes.winner : ''}`}>
                    {tours.playoff[999][0]?.teamTwo}
                  </h3>
                  <h3 className={`${classes.score} ${tours.playoff[999][0]?.winner === tours.playoff[999][0]?.teamTwo ? classes.winner : ''}`}>
