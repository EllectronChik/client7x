...
const Footer: React.FC<React.HTMLProps<HTMLDivElement>> = ({...props}) => {
    ...
    const russianLanguageCodes = ['ru', 'ru-RU', 'ru-UA', 'ru-BY', 'ru-KZ', 'ru-KG', 'ru-MD' ];
    ...
    if (!cookie?.locale && (russianLanguageCodes.includes(window.navigator.language))) {
        language = LOCALES.RUSSIAN;
    } else if (!cookie?.locale && (ukrainianLanguageCodes.includes(window.navigator.language))) {
    ...
    <footer className={propsClassName}>
        ...
        <div className={classes.container}>
            <div className={classes.language}>
                <h3><FormattedMessage id="language"/>:</h3>
            ...
            <div>
                <p>
                    &copy;2002-{new Date().getFullYear()} 7x.ru sc2 Team
                </p>
            </div>
            <div className={classes.copyright}>
                <div>
                    ...
                    <p>
                        <FormattedMessage id='blizzardOwnership' /> <a target="_blank" className={classes.link} href="https://www.blizzard.com">Blizzard Entertainment</a>.
                    </p>
                </div>
                <div>
